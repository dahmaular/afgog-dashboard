  ...
  return (
    <Fragment>
      <div className="form-check">
        ...
        <Label className="form-check-label" htmlFor="validationFormCheck2">{ToggleThisRadio}</Label>
      </div>
      <div className="form-check mb-3">
        <Input className="form-check-input" id="validationFormCheck3" type="radio" name="radio-stacked" required/>
        <Label className="form-check-label" htmlFor="validationFormCheck3">{OrToggleThisRadio}</Label>
