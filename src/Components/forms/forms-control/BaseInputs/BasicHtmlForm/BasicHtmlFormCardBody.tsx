import { Password, SimpleInput, Placeholder, Date, Month, Time, ColorPicker, MaximumLength, Textarea, StaticText, Telephone, DateAndTime, Week, Number, URL,} from "../../../../../Constant";
    ...
    <Form className="form theme-form" onSubmit={(e)=>(e.preventDefault())}>
      <CardBody>
        <Row>
          ...
          <CommonFormGroup label={DateAndTime} ColSm={9} InputType="datetime-local"  id="example-datetime-local-input"   defaultValue="2022-01-19T18:45:00"/>
          <CommonFormGroup label={Date} ColSm={9} InputType="date"  InputClass="digits"   defaultValue="2022-01-0100"/>
          <CommonFormGroup label={Month} ColSm={9} InputType="month"  InputClass="digits"   defaultValue="2022-01"/>
          <CommonFormGroup label={Week} ColSm={9} InputType="week"  InputClass="digits"   defaultValue="2022-W09"/>
          ...
          <CommonFormGroup label={MaximumLength} ColSm={9} InputType="text"  placeholder="Content must be in 6 characters"     maxLength={6}/>
            <FormGroup className="row">
              ...
              <Col sm="9"><div className="form-control-static">{"Hello !... This is static text"}</div></Col>
            </FormGroup>
            <FormGroup className="row mb-0">
              <Label className="col-sm-3 col-form-label">{Textarea}</Label>
              <Col sm="9"><textarea className="form-control" rows={5} cols={5} placeholder="Default textarea"></textarea></Col>
            </FormGroup>
          </Col>
        </Row>
      </CardBody>
