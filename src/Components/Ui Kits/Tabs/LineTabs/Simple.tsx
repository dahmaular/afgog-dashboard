...
const Simple = () => {
  ...
  return (
    <Col sm="12" xl="6 xl-100">
      <Card>
      <HeadingCommon Heading="Simple Material Style Tab" dangerouslySetInnerHTML={span} />
        <CardBody>
          <Nav className="border-tab" tabs>
            <NavItem>
              <NavLink href="#javascript" className={BasicLineTab === '1' ? 'active' : ''} onClick={() => setBasicLineTab('1')}><i className="icofont icofont-ui-home"></i>Home</NavLink>
            </NavItem>
            <NavItem>
