...
const PrimaryColorTab = () => {
  const span =`.nav-primary</code> class with nav class`
      ...
      <HeadingCommon Heading="Material Color Tab" dangerouslySetInnerHTML={span} />
        <CardBody>
          <Nav className="border-tab nav-primary" tabs>
            <NavItem>
              <NavLink href="#javascript" className={PrimarycolorLineTab === '1' ? 'active' : ''} onClick={() => setPrimarycolorLineTab('1')}><i className="icofont icofont-ui-home"></i>Home</NavLink>
            </NavItem>
            <NavItem>
