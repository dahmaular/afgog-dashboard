...
export const ProductDescription = "Project Description";
...
export const ProductTittle = "Women Black T-shirt";
...
export const Basicemailpara2 =
  "Sometimes you just want to send a simple HTML email with a simple design and clear call to action.";
export const HiThere = "Hi There,";
export const Agreewith = "Agree with";
export const SomeDescription = "Some Description";
export const PrivacyPolicy = "Privacy Policy";
export const SignUpOpportunities =
...
export const VendorPersonal = "Enter your Personal details to begin";
